...
function exportExcel() {
  ...
  let html =
    '<!DOCTYPE html><html><head><meta charset="UTF-8" /><style>td{mso-number-format:"\\@";white-space:normal;line-height:1.5;vertical-align:top;}</style></head><body><table border="1"><thead><tr>'
