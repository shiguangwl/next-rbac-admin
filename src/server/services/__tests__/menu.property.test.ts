...
import { type MenuDto, type MenuTreeNode, buildMenuTree } from '../menu.service'
...
const menuDtoArb = fc.record({
  ...
  permission: fc.option(fc.string({ minLength: 1, maxLength: 100 }), { nil: null }),
  path: fc.option(fc.string({ minLength: 1, maxLength: 200 }), { nil: null }),
  component: fc.option(fc.string({ minLength: 1, maxLength: 200 }), { nil: null }),
