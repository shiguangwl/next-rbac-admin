...
admins.use(
  ...
  auditLog({ module: '管理员管理', operation: '创建', description: '创建管理员' })
)
...
admins.use(
  ...
  auditLog({ module: '管理员管理', operation: '更新', description: '更新管理员信息' })
)
...
admins.use(
  ...
  auditLog({ module: '管理员管理', operation: '删除', description: '删除管理员' })
)
admins.openapi(deleteAdminRoute, async (c) => {
  ...
  return c.json({ success: true as const, message: '删除成功' }, 200)
})
...
admins.use(
  ...
  auditLog({ module: '管理员管理', operation: '重置密码', description: '重置管理员密码' })
)
admins.openapi(resetPasswordRoute, async (c) => {
  ...
  return c.json({ success: true as const, message: '密码重置成功' }, 200)
})
...
admins.use(
  ...
  auditLog({ module: '管理员管理', operation: '分配角色', description: '更新管理员角色' })
)
admins.openapi(updateAdminRolesRoute, async (c) => {
  ...
  return c.json({ success: true as const, message: '角色更新成功' }, 200)
})
