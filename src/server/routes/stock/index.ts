...
stock.use(
  createStockConfigRoute.path,
  requireAuth,
  requirePermission("stock:config:create")
);
...
stock.use(
  updateStockConfigRoute.path,
  requireAuth,
  requirePermission("stock:config:update")
);
...
stock.use(
  deleteStockConfigRoute.path,
  requireAuth,
  requirePermission("stock:config:delete")
);
