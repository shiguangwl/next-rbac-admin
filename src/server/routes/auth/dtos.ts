...
export const AdminInfoSchema = z
  .object({
    ...
    nickname: z
      .string()
      .openapi({ description: "昵称", example: "系统管理员" }),
    status: z
      .number()
    ...
    loginIp: z
      .string()
      .nullable()
      .openapi({ description: "最后登录 IP", example: "127.0.0.1" }),
    loginTime: z
      .string()
      .nullable()
      .openapi({
    ...
    roles: z
      .array(RoleBriefSchema)
      .optional()
      .openapi({ description: "角色列表" }),
  })
  .openapi("AdminInfo");
...
export const MenuTreeNodeSchema: z.ZodType<MenuTreeNode> = z
  .lazy(() =>
    z.object({
      ...
      menuName: z
        .string()
        .openapi({ description: "菜单名称", example: "系统管理" }),
      permission: z
        .string()
        .nullable()
      ...
      path: z
        .string()
        .nullable()
        .openapi({ description: "路由路径", example: "/system" }),
      component: z
        .string()
        .nullable()
      ...
      icon: z
        .string()
        .nullable()
        .openapi({ description: "图标", example: "setting" }),
