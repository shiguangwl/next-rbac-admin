  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          (error as { message?: string }).message || "获取角色列表失败"
        );
      }
...
export function useAllRoles() {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await getApiClient().roles.all.$get();
      if (!response.ok) {
        const error = await response.json();
        throw new Error(
          (error as { message?: string }).message || "获取角色列表失败"
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      if (!response.ok) {
        const error = await response.json();
        throw new Error(
          (error as { message?: string }).message || "获取角色详情失败"
        );
      }
      const result = await response.json();
      return (result as { data: unknown }).data;
  ...
  return useMutation({
    mutationFn: async (input: CreateRoleInput) => {
      ...
      if (!response.ok) {
        const error = await response.json();
        throw new Error(
          (error as { message?: string }).message || "创建角色失败"
        );
      }
      const result = await response.json();
      return (result as { data: unknown }).data;
  ...
  return useMutation({
    mutationFn: async ({
      ...
      if (!response.ok) {
        const error = await response.json();
        throw new Error(
          (error as { message?: string }).message || "更新角色失败"
        );
      }
      const result = await response.json();
      return (result as { data: unknown }).data;
  ...
  return useMutation({
    mutationFn: async (id: number) => {
      ...
      if (!response.ok) {
        const error = await response.json();
        throw new Error(
          (error as { message?: string }).message || "删除角色失败"
        );
      }
      const result = await response.json();
      return (result as { data: unknown }).data;
  ...
  return useMutation({
    mutationFn: async ({
      ...
      if (!response.ok) {
        const error = await response.json();
        throw new Error(
          (error as { message?: string }).message || "更新角色菜单权限失败"
        );
      }
      const result = await response.json();
      return (result as { data: unknown }).data;
