  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          (error as { message?: string }).message || "获取管理员列表失败"
        );
      }
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      if (!response.ok) {
        const error = await response.json();
        throw new Error(
          (error as { message?: string }).message || "获取管理员详情失败"
        );
      }
      const result = await response.json();
      return (result as { data: unknown }).data;
  ...
  return useMutation({
    mutationFn: async (input: CreateAdminInput) => {
      ...
      if (!response.ok) {
        const error = await response.json();
        throw new Error(
          (error as { message?: string }).message || "创建管理员失败"
        );
      }
      const result = await response.json();
      return (result as { data: unknown }).data;
  ...
  return useMutation({
    mutationFn: async ({
      ...
      if (!response.ok) {
        const error = await response.json();
        throw new Error(
          (error as { message?: string }).message || "更新管理员失败"
        );
      }
      const result = await response.json();
      return (result as { data: unknown }).data;
  ...
  return useMutation({
    mutationFn: async (id: number) => {
      ...
      if (!response.ok) {
        const error = await response.json();
        throw new Error(
          (error as { message?: string }).message || "删除管理员失败"
        );
      }
      const result = await response.json();
      return (result as { data: unknown }).data;
...
export function useResetPassword() {
  return useMutation({
    mutationFn: async ({
      ...
      const response = await getApiClient().admins[":id"][
        "reset-password"
      ].$put({
        param: { id: String(id) },
        json: input,
      ...
      if (!response.ok) {
        const error = await response.json();
        throw new Error(
          (error as { message?: string }).message || "重置密码失败"
        );
      }
      const result = await response.json();
      return (result as { data: unknown }).data;
  ...
  return useMutation({
    mutationFn: async ({
      ...
      if (!response.ok) {
        const error = await response.json();
        throw new Error(
          (error as { message?: string }).message || "更新管理员角色失败"
        );
      }
      const result = await response.json();
      return (result as { data: unknown }).data;
