          ...
          <div className="w-full max-w-3xl rounded-lg bg-white p-6 shadow-lg">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-3">
              ...
              <div>
                ...
                <select
                  value={createForm.isSystem}
                  onChange={(e) =>
                    setCreateForm({
                      ...createForm,
                      isSystem: Number(e.target.value) as 0 | 1,
                    })
                  }
                  className="w-full rounded-lg  px-3 py-2 text-sm focus:lue-500 focus:outline-none"
                >
  ...
  if (!value) {
    return (
      <div className="mt-3">
        ...
        <div className="rounded bg-gray-900 px-3 py-2 text-xs font-mono text-gray-400">
          (空)
        </div>
      </div>
    );
